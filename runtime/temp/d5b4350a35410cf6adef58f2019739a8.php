<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/www/wwwroot/test.nuosike.com/public/../application/admin/view/category/add.html";i:1611481140;s:72:"/www/wwwroot/test.nuosike.com/application/admin/view/layout/default.html";i:1583049508;s:69:"/www/wwwroot/test.nuosike.com/application/admin/view/common/meta.html";i:1583049508;s:71:"/www/wwwroot/test.nuosike.com/application/admin/view/common/script.html";i:1583049508;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
 ...
 <div class="form-group">
        <label for="c-bt2b" class="control-label col-xs-12 col-sm-2">是否蓝秦云链接:</label>
        <div class="col-xs-12 col-sm-8">
            <select class="form-control"  name="row[flag]" >
			<option value="0">非蓝秦云</option>
            <option value="1">蓝秦云</option> 
            </select>
        </div>
    </div>
    <div class="form-group">
